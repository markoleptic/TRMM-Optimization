...
# Build the verifier
${CC} $CFLAGS -std=c99 ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR01_FILE}.o -o ./run_test_op_var01.x
${CC} $CFLAGS -std=c99 ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR02_FILE}.o -o ./run_test_op_var02.x
${CC} $CFLAGS -std=c99 ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR03_FILE}.o -o ./run_test_op_var03.x
${CC} $CFLAGS -std=c99 ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR04_FILE}.o -o ./run_test_op_var04.x
${CC} $CFLAGS -std=c99 ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR05_FILE}.o -o ./run_test_op_var05.x
${CC} $CFLAGS -std=c99 ${TEST_RIG}.o ${OP_BASELINE_FILE}.ref.o ${OP_SUBMISSION_VAR06_FILE}.o -o ./run_test_op_var06.x
